...
{
  static Protocol__FlexHeader init_value = PROTOCOL__FLEX_HEADER__INIT;
  *message = init_value;
}
...
static const ProtobufCEnumValue protocol__flex_type__enum_values_by_number[22] =
{
  ...
  { "FLPT_DELEGATE_REQUEST", "PROTOCOL__FLEX_TYPE__FLPT_DELEGATE_REQUEST", 22 },
};
static const ProtobufCIntRange protocol__flex_type__value_ranges[] = {
{0, 0},{20, 19},{0, 22}
};
static const ProtobufCEnumValueIndex protocol__flex_type__enum_values_by_name[22] =
{
  { "FLPT_DELEGATE_CONTROL", 15 },
  { "FLPT_DELEGATE_REQUEST", 21 },
  { "FLPT_DISCONNECT", 19 },
