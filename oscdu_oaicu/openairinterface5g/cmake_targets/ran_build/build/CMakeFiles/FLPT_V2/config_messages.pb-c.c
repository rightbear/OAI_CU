...
{
  static Protocol__FlexCellConfig init_value = PROTOCOL__FLEX_CELL_CONFIG__INIT;
  *message = init_value;
}
...
{
  static Protocol__FlexSliceConfig init_value = PROTOCOL__FLEX_SLICE_CONFIG__INIT;
  *message = init_value;
}
...
{
  static Protocol__FlexUeConfig init_value = PROTOCOL__FLEX_UE_CONFIG__INIT;
  *message = init_value;
}
...
{
  static Protocol__FlexLcUeConfig init_value = PROTOCOL__FLEX_LC_UE_CONFIG__INIT;
  *message = init_value;
}
...
{
  static Protocol__FlexS1apConfig init_value = PROTOCOL__FLEX_S1AP_CONFIG__INIT;
  *message = init_value;
}
...
static const ProtobufCFieldDescriptor protocol__flex_slice_config__field_descriptors[2] =
{
  {
    "dl",
    6,
    ...
    &protocol__flex_slice_dl_ul_config__descriptor,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
