...
typedef struct _Protocol__FlexSliceStatic Protocol__FlexSliceStatic;
typedef struct _Protocol__FlexSlice Protocol__FlexSlice;
typedef struct _Protocol__FlexSliceDlUlConfig Protocol__FlexSliceDlUlConfig;
 ...
 */
typedef enum _Protocol__FlexSliceAlgorithm {
  PROTOCOL__FLEX_SLICE_ALGORITHM__None = 0,
  PROTOCOL__FLEX_SLICE_ALGORITHM__Static = 1,
  PROTOCOL__FLEX_SLICE_ALGORITHM__NVS = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PROTOCOL__FLEX_SLICE_ALGORITHM)
...
struct  _Protocol__FlexSliceStatic
{
  ProtobufCMessage base;
  protobuf_c_boolean has_poslow;
  uint32_t poslow;
  protobuf_c_boolean has_poshigh;
  uint32_t poshigh;
};
#define PROTOCOL__FLEX_SLICE_STATIC__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&protocol__flex_slice_static__descriptor) \
    , 0,0, 0,0 }


typedef enum {
  PROTOCOL__FLEX_SLICE__PARAMS__NOT_SET = 0,
  PROTOCOL__FLEX_SLICE__PARAMS_STATIC = 10,
} Protocol__FlexSlice__ParamsCase;

struct  _Protocol__FlexSlice
{
  ProtobufCMessage base;
  ...
  char *label;
  char *scheduler;
  Protocol__FlexSlice__ParamsCase params_case;
  union {
    Protocol__FlexSliceStatic *static_;
  };
};
#define PROTOCOL__FLEX_SLICE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&protocol__flex_slice__descriptor) \
    , 0,0, NULL, NULL, PROTOCOL__FLEX_SLICE__PARAMS__NOT_SET, {0} }


struct  _Protocol__FlexSliceDlUlConfig
{
  ProtobufCMessage base;
  protobuf_c_boolean has_algorithm;
  Protocol__FlexSliceAlgorithm algorithm;
  size_t n_slices;
  Protocol__FlexSlice **slices;
  /*
   * if no slicing
   */
  char *scheduler;
};
#define PROTOCOL__FLEX_SLICE_DL_UL_CONFIG__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&protocol__flex_slice_dl_ul_config__descriptor) \
    , 0,0, 0,NULL, NULL }
...
void   protocol__flex_si_message__free_unpacked
                     (Protocol__FlexSiMessage *message,
                      ProtobufCAllocator *allocator);
/* Protocol__FlexSliceStatic methods */
...
void   protocol__flex_slice__free_unpacked
                     (Protocol__FlexSlice *message,
                      ProtobufCAllocator *allocator);
/* Protocol__FlexSliceDlUlConfig methods */
...
typedef void (*Protocol__FlexSiMessage_Closure)
                 (const Protocol__FlexSiMessage *message,
                  void *closure_data);
typedef void (*Protocol__FlexSliceStatic_Closure)
                 (const Protocol__FlexSliceStatic *message,
                  void *closure_data);
typedef void (*Protocol__FlexSlice_Closure)
                 (const Protocol__FlexSlice *message,
                  void *closure_data);
typedef void (*Protocol__FlexSliceDlUlConfig_Closure)
                 (const Protocol__FlexSliceDlUlConfig *message,
                  void *closure_data);
...
extern const ProtobufCEnumDescriptor    protocol__flex_slice_algorithm__descriptor;
...
extern const ProtobufCMessageDescriptor protocol__flex_slice_static__descriptor;
extern const ProtobufCMessageDescriptor protocol__flex_slice__descriptor;
extern const ProtobufCMessageDescriptor protocol__flex_slice_dl_ul_config__descriptor;
