...
{
  static Protocol__FlexDlDci init_value = PROTOCOL__FLEX_DL_DCI__INIT;
  *message = init_value;
}
...
{
  static Protocol__FlexUlDci init_value = PROTOCOL__FLEX_UL_DCI__INIT;
  *message = init_value;
}
...
{
  static Protocol__FlexRlcPdu init_value = PROTOCOL__FLEX_RLC_PDU__INIT;
  *message = init_value;
}
...
{
  static Protocol__FlexRlcPduTb init_value = PROTOCOL__FLEX_RLC_PDU_TB__INIT;
  *message = init_value;
}
