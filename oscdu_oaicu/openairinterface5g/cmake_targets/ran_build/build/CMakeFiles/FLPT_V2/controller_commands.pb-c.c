...
{
  static Protocol__FlexDlData init_value = PROTOCOL__FLEX_DL_DATA__INIT;
  *message = init_value;
}
...
{
  static Protocol__FlexUlData init_value = PROTOCOL__FLEX_UL_DATA__INIT;
  *message = init_value;
}
...
{
  static Protocol__FlexDlRar init_value = PROTOCOL__FLEX_DL_RAR__INIT;
  *message = init_value;
}
...
{
  static Protocol__FlexDlBroadcast init_value = PROTOCOL__FLEX_DL_BROADCAST__INIT;
  *message = init_value;
}
...
{
  static Protocol__FlexPdcchOfdmSymCount init_value = PROTOCOL__FLEX_PDCCH_OFDM_SYM_COUNT__INIT;
  *message = init_value;
}
