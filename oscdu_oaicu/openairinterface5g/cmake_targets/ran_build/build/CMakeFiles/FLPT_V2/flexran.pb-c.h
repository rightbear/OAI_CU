...
typedef struct _Protocol__FlexControlDelegationRequest Protocol__FlexControlDelegationRequest;
...
typedef enum {
  ...
  PROTOCOL__FLEXRAN_MESSAGE__MSG_CONTROL_DEL_REQ_MSG = 22,
...
struct  _Protocol__FlexranMessage
{
  ...
  union {
    ...
    Protocol__FlexControlDelegationRequest *control_del_req_msg;
  };
};
#define PROTOCOL__FLEXRAN_MESSAGE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&protocol__flexran_message__descriptor) \
    , 0,0, PROTOCOL__FLEXRAN_MESSAGE__MSG__NOT_SET, {0} }
...
#define PROTOCOL__FLEX_STATS_REQUEST__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&protocol__flex_stats_request__descriptor) \
    , NULL, 0,0, PROTOCOL__FLEX_STATS_REQUEST__BODY__NOT_SET, {0} }
...
struct  _Protocol__FlexControlDelegation
{
  ...
  Protocol__FlexControlDelegationType delegation_type;
  /*
...
struct  _Protocol__FlexControlDelegationRequest
{
  ProtobufCMessage base;
  Protocol__FlexHeader *header;
  protobuf_c_boolean has_delegation_type;
...
#define PROTOCOL__FLEX_CONTROL_DELEGATION_REQUEST__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&protocol__flex_control_delegation_request__descriptor) \
    , NULL, 0,0, NULL }
...
struct  _Protocol__FlexAgentReconfiguration
{
   ...
   */
  size_t n_systems;
  Protocol__FlexAgentReconfigurationSystem **systems;
};
...
void   protocol__flex_control_delegation__free_unpacked
                     (Protocol__FlexControlDelegation *message,
                      ProtobufCAllocator *allocator);
/* Protocol__FlexControlDelegationRequest methods */
...
typedef void (*Protocol__FlexControlDelegation_Closure)
                 (const Protocol__FlexControlDelegation *message,
                  void *closure_data);
typedef void (*Protocol__FlexControlDelegationRequest_Closure)
                 (const Protocol__FlexControlDelegationRequest *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor protocol__flex_control_delegation_request__descriptor;
